...
const CreatePost = () => {
      ...
      const generateImage = async () => {
            if (form.prompt) {
                  try {
                        ...
                        alert(error)
                        console.log(error + ": CreatePost.jsx")
                  } finally {
      ...
      const handleSubmit = async (e) => {
            e.preventDefault(); //prevent browser from autoloading
            ...
            if (form.prompt && form.photo) {
                  ...
                  try {
                        ...
                        alert("this error is coming : CreatePost.js" + err)
                  }
                  finally {
                        setLoading(false)
                  }
                  ...
                  alert("Please enter a re-prompt and generate a photo");
            }
      }
            ...
            <section>
                  ...
                  <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                        ...
                        <div className='mt-5 flex gap-5'>
                              <button type='button' onClick={generateImage} className='text-white bg-green-700 font-medium text-center rounded-md text-sm  w-full sm:w-auto px-5 py-2.5'>
